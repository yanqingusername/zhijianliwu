...
<template>
	<view class="ynGalleryPanel">
		<view  class="gallerypanel" style="filter:brightness(1);border-radius:1upx" :style="{'background':bkstyle,'height':galleryheight+'px','width':'100%'}">
			<scroll-view class="scroll-view" scroll-x="true" show-scrollbar="false" scroll-with-animation="true" :scroll-into-view="toview" :scroll-left="scrollLeft" @scroll="scroll">
				...
				<view class="scroll-view-panle" @touchend='touchEndHandle' @touchstart='touchStartHandle' @touchmove='touchMoveHandle'>
					...
					<view :id="'imgviewpanel'+index" :ref="'imgviewpanel'+index" :class="[activeviewindex == index? 'trans-fadeout':  '']"
						   ...
						   style="display:flex;flex-direction: column;align-content:center;justify-content: flex-end;">
						<!-- 内层 高度是图片容器的高度 -->
					    <!-- 顶部圆角角标 -->						
						...
						<view style="display:flex; align-content:flex-end;justify-content: center; border:red 0px solid;"
							  ...
							  <image   :ref="'image'+index" 
							            style="align-self: center;border-radius: 3px; " 

	...
	<view>
		<view class="personal-header">
			...
			<view class="personal-center" :style="'margin-top:' + (fixed==1 ? '-2' : '22') +'rpx'">
				<view class="personal-center-left">
					<image class="personal-sign-img" v-if="sign.id" :src="sign.head_img" mode=""></image>
					<image class="personal-sign-img" v-else src="../../static/my-touxiang.jpg" mode=""></image>
			...
			<view class="personal-bottom" @click="$buttonClick(opening)">
				...
				<view class="personal-bottom-view">立即开通</view>	
			</view>
			<!-- 背景图 -->
		</view>
		...
		<view class="personal-item margin-auto">
			...
			<view class="personal-item-ul flex-between">
				<view class="personal-item-li" @click="$buttonClick(order)">
		...
		// 路由
			...
			colloection:function(e){
				uni.navigateTo({
					...
					url: '../index-coupon/ExchangeIndex'
				})
			},
		    // 立即开通  会员中心
			opening:function(e){

<template>
	<view class="bag">
		...
		<view class="bag-con">
			<image class="bag-head" src="https://zhijianlw.com/static/web/img/empty_page_xm.png" mode=""></image>
			<text class="bag-font">熊猫送出的礼物</text>
			...
			<view class="bag-gift">
				<view class="bag-gift-title">
					<text class="bag-gift-title-font">该礼包礼物已被领取，6分钟抢完</text>
				</view>
